...
fun f() {
    ...
    A().foo(1, <!NAMED_ARGUMENTS_NOT_ALLOWED!>args<!> = <!REDUNDANT_SPREAD_OPERATOR_IN_NAMED_FORM_IN_FUNCTION, SPREAD_OF_NULLABLE!>*<!>args)
    bar(2, <!SPREAD_OF_NULLABLE!>*<!><!TYPE_MISMATCH!>args<!>)
    bar(2, s = <!REDUNDANT_SPREAD_OPERATOR_IN_NAMED_FORM_IN_FUNCTION, SPREAD_OF_NULLABLE!>*<!><!TYPE_MISMATCH!>args<!>)
...
fun h(b: B) {
    if (b.args != null) {
        ...
        A().foo(1, <!NAMED_ARGUMENTS_NOT_ALLOWED!>args<!> = <!REDUNDANT_SPREAD_OPERATOR_IN_NAMED_FORM_IN_FUNCTION, SPREAD_OF_NULLABLE!>*<!>b.args)
    }
}

fun k() {
    A().foo(1, <!SPREAD_OF_NULLABLE!>*<!>getArr())
    A().foo(1, <!NAMED_ARGUMENTS_NOT_ALLOWED!>args<!> = <!REDUNDANT_SPREAD_OPERATOR_IN_NAMED_FORM_IN_FUNCTION, SPREAD_OF_NULLABLE!>*<!>getArr())
    bar(2, <!SPREAD_OF_NULLABLE!>*<!><!TYPE_MISMATCH!>getArr()<!>)
    bar(2, s = <!REDUNDANT_SPREAD_OPERATOR_IN_NAMED_FORM_IN_FUNCTION, SPREAD_OF_NULLABLE!>*<!><!TYPE_MISMATCH!>getArr()<!>)
