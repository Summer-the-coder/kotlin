...
import org.jetbrains.kotlin.fir.resolve.transformers.contracts.ContractsDslNames.CALLS_IN_PLACE
import org.jetbrains.kotlin.fir.resolve.transformers.contracts.ContractsDslNames.CONTRACT
import org.jetbrains.kotlin.fir.resolve.transformers.contracts.ContractsDslNames.CONTRACTS_DSL_ANNOTATION_FQN
import org.jetbrains.kotlin.fir.resolve.transformers.contracts.ContractsDslNames.EFFECT
import org.jetbrains.kotlin.fir.resolve.transformers.contracts.ContractsDslNames.IMPLIES
import org.jetbrains.kotlin.fir.resolve.transformers.contracts.ContractsDslNames.INVOCATION_KIND_ENUM
import org.jetbrains.kotlin.fir.resolve.transformers.contracts.ContractsDslNames.RETURNS
import org.jetbrains.kotlin.fir.resolve.transformers.contracts.ContractsDslNames.RETURNS_NOT_NULL
