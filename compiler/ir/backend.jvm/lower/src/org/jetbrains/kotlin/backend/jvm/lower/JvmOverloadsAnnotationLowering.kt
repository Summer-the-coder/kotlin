...
@PhaseDescription(
    ...
    prerequisite = [JvmVersionOverloadsLowering::class],
)
internal class JvmOverloadsAnnotationLowering(val context: JvmBackendContext) : ClassLoweringPass {
    ...
    private fun IrClass.hasConflictingOverloads(wrapper: IrFunction): Boolean {
        return functions.any {
            context.defaultMethodSignatureMapper.mapAsmMethod(it) == context.defaultMethodSignatureMapper.mapAsmMethod(wrapper)
        }
    }
